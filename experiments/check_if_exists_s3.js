    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, s3.headObject({ Bucket: bucketName, Key: fileName }).promise()];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    throw err_1; // Other error occurred
...
// Usage
var fileName = 'uploads/090151b2804eada1.pdf';
checkFileExists(bucketName, fileName)
    .then(function (exists) {
    console.log("File \"".concat(fileName, "\" exists in S3: ").concat(exists));
})
    .catch(function (err) {
