...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var url, key, buffer, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    url = 'https://epawebapp.epa.ie/licences/lic_eDMS/090151b28087909f.pdf';
                    key = 'test_090151b28087909f.pdf';
                    console.log('Downloading PDF...');
                    return [4 /*yield*/, downloadPDF(url)];
                case 1:
                    buffer = _a.sent();
